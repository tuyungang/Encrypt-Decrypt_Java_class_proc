...
void Des::Xor(unsigned char * p_buf_1, const unsigned char * p_buf_2, unsigned char bytes) 
{
    while (bytes > 0) {
        bytes--;
...
void Des::move_left(unsigned char * p_input, unsigned char bit_start, unsigned char bit_end, unsigned char offset) 
{
...
void Des::move_right(unsigned char * p_input, unsigned char bit_start, unsigned char bit_end, unsigned char offset) 
{
    unsigned char b_val = 0;
    unsigned char b_tmp1 = 0;
    unsigned char b_tmp2 = 0;
...
void Des::move_bits(unsigned char * p_input, unsigned char bit_start, unsigned char bit_end, char offset) 
{
    if (0 < offset) 
    {
...
void Des::Permutation(unsigned char * p_input, unsigned char * p_output, const unsigned char * Table, unsigned char bits) 
{
